...
execute as @a[tag=arg] at @s run title @s title {"text":"Congratulations","color":"green","bold":true}
execute as @a[tag=arg] at @s run tellraw @s {"text":"May your fish be eternalized","color":"green","bold":true}
